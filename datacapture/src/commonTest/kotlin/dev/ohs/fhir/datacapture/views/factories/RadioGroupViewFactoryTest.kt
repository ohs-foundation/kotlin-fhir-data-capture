...
import dev.ohs.fhir.datacapture.views.components.CHOICE_RADIO_BUTTON_IMAGE_TAG
...
class RadioGroupViewFactoryTest {

  @Composable
  fun QuestionnaireRadioGroup(questionnaireViewItem: QuestionnaireViewItem) {
    QuestionnaireTheme { RadioGroupViewFactory.Content(questionnaireViewItem) }
  }
  ...
  fun bind_shouldSetQuestionHeader() = runComposeUiTest {
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
        ...
        QuestionnaireResponse.Item(linkId = FhirR4String(value = "radio-group-item")),
        validationResult = NotValidated,
        answersChangedCallback = { _, _, _, _ -> },
      )

    setContent { QuestionnaireRadioGroup(questionnaireViewItem) }

    onNodeWithTag(QUESTION_HEADER_TAG).assertTextEquals("Question?")
  }

  @Test
  fun bind_vertical_shouldCreateRadioButtons() = runComposeUiTest {
    val questionnaire =
      Questionnaire.Item(
        linkId = FhirR4String(value = "radio-group-item"),
        type = Enumeration(value = Questionnaire.QuestionnaireItemType.Choice),
    ...
    onAllNodes(hasTestTag(RADIO_OPTION_TAG)).assertCountEquals(2)
    questionnaire.answerOption.forEachIndexed { index, opt ->
      onAllNodes(hasTestTag(RADIO_OPTION_TAG))[index].assertTextEquals(
        opt.value.asCoding()?.value?.display?.value!!,
      )

      val node = onAllNodes(hasTestTag(RADIO_OPTION_TAG))[index]
  ...
  @Test
  fun bind_horizontal_shouldCreateRadioButtons() = runComposeUiTest {
    val questionnaire =
      Questionnaire.Item(
        linkId = FhirR4String(value = "radio-group-item"),
        type = Enumeration(value = Questionnaire.QuestionnaireItemType.Choice),
  ...
  @Test
  fun bind_noAnswer_shouldLeaveRadioButtonsUnchecked() = runComposeUiTest {
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
    ...
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).assertIsNotSelected()
  }
  ...
  fun bind_withImageInItemAnswerMediaExtension_shouldShowImageAfterRadioButtons() =
    runComposeUiTest {
      ...
      setContent { QuestionnaireRadioGroup(questionnaireViewItem) }
      onNodeWithTag(CHOICE_RADIO_BUTTON_IMAGE_TAG, useUnmergedTree = true).assertIsDisplayed()
    }

  @Test
  fun bind_answer_shouldCheckRadioButton() = runComposeUiTest {
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
    ...
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).assertIsSelected()

    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 2")).assertIsNotSelected()
  }

  @Test
  fun click_shouldSetQuestionnaireResponseItemAnswer() = runComposeUiTest {
    ...
    setContent { QuestionnaireRadioGroup(questionnaireViewItem) }
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).performClick()
  ...
  @Test
  fun click_shouldCheckRadioButton() = runComposeUiTest {
  ...
  @Test
  fun click_shouldCheckOtherRadioButton() = runComposeUiTest {
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
    ...
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 2")).performClick()

    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).assertIsNotSelected()
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 2")).assertIsSelected()
  }

  @Test
  fun unselectRadioButtonIfSelectedRadioButtonIsClicked() = runComposeUiTest {
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
  ...
  @Test
  fun clearTheAnswerIfSelectedRadioButtonIsClicked() = runComposeUiTest {
    var answersHolder: List<QuestionnaireResponse.Item.Answer>? = null
    val questionnaireViewItem =
      QuestionnaireViewItem(
        Questionnaire.Item(
          linkId = FhirR4String(value = "radio-group-item"),
        ...
        QuestionnaireResponse.Item(linkId = FhirR4String(value = "radio-group-item")),
        validationResult = NotValidated,
        answersChangedCallback = { _, _, answers, _ -> answersHolder = answers },
      )

    setContent { QuestionnaireRadioGroup(questionnaireViewItem) }
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).performClick()
    waitUntil { answersHolder != null }
    answersHolder.shouldNotBeEmpty()

    answersHolder = null
    onNode(hasTestTag(RADIO_OPTION_TAG) and hasText("Coding 1")).performClick()
    waitUntil { answersHolder != null }

    answersHolder.shouldBeEmpty()
  }
  ...
  fun bind_readOnly_shouldDisableView() = runComposeUiTest {
    ...
    setContent { QuestionnaireRadioGroup(questionnaireViewItem) }
    onAllNodes(hasTestTag(RADIO_OPTION_TAG)).assertAll(isNotEnabled())
  }
