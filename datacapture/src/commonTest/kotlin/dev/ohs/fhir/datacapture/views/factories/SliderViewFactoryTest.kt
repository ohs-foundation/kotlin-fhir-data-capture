...
class SliderViewFactoryTest {
  ...
  /**
   * Asserts [ProgressBarRangeInfo.current] within a tolerance; [range] and [steps] are compared
   * exactly. Material3's Slider derives `current` from a fraction/position round-trip that is not
   * bit-identical across Kotlin targets (current=10 renders as 10.000000149011612 on Kotlin/JS and
   * as exactly 10 on JVM/Wasm).
   */
