...
import kotlin_fhir_data_capture.datacapture_kmp.generated.resources.ic_clear
...
internal fun MultiAutoCompleteTextItem(
  ...
  val filteredOptions =
    remember(options, autoCompleteText) {
      options.filter { it.displayString.contains(autoCompleteText.text, true) }
    }
  ...
  val chipMargin = QuestionnaireTheme.dimensions.autoCompleteChipMargin
  val chipMarginBottom = QuestionnaireTheme.dimensions.autoCompleteChipMarginBottom
  val textFieldContentPadding = QuestionnaireTheme.dimensions.autoCompleteTextFieldContentPadding
        ...
        FlowRow(
          ...
          selectedOptions.forEach {
            InputChip(
              ...
              label = { Text(it.displayAnnotatedString()) },
              trailingIcon = {
                Icon(
                  painterResource(Res.drawable.ic_clear),
                  contentDescription = "Remove ${it.displayString}",
                )
              },
            )
          }
