...
import dev.ohs.fhir.datacapture.views.components.OptionDialogSelect
import dev.ohs.fhir.datacapture.views.components.OptionSelectOption
        ...
        OutlinedTextField(
          ...
          modifier =
            Modifier.fillMaxWidth()
              ...
              .semantics { if (hasValidationError) SemanticsError(supportingHelperText ?: "") }
