...
class AndroidDateViewFactoryTest {
    ...
    fun shouldSetDateInput_localeUs() = runComposeUiTest {
         ...
         true).assertTextEquals("10/19/2020")
    }
                  ...
                  Locale.setDefault(Locale.US)
                    val questionnaireViewItem = QuestionnaireViewItem(
                        Questionnaire.Item(
                            ...
                            extension = listOf(
                                Extension(
                                    url = EXTENSION_ENTRY_FORMAT_URL, value =
